 ...
 */
import {createElement, DisplayObject} from 'lomo';
export default class TestSVG extends DisplayObject {
    render(){
        return (
            <svg version="1.1" width="516.3px" height="190px" viewBox="0 0 516.3 190" style="enable-background:new 0 0 516.3 211.99;">
